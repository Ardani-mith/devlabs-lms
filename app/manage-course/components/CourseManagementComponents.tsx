...
export const CourseStatsGrid: React.FC<CourseStatsGridProps> = ({ stats }) => (
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
    ...
    <StatCard
      ...
      icon={ChartBarIcon}
      color="text-brand-purple dark:text-purple-400"
...
export const CourseManagementHeader: React.FC<CourseManagementHeaderProps> = ({ onCreateClick }) => (
